...
* [MobilePlayer](https://github.com/mobileplayer/mobileplayer-ios) - 一个强大、可自定义的媒体播放器.   ---- (Star:2,181) (Fork:217) (Watch:95)  
...
* [Blurable.swift](https://github.com/FlexMonkey/Blurable) - swift模糊组件。   ---- (Star:799) (Fork:58) (Watch:12)  
...
* [GMStepper](https://github.com/gmertk/GMStepper) - swift 带动画效果、支持手势滑动操作的步进标签。   ---- (Star:543) (Fork:52) (Watch:13)  
...
* [Koloda](https://github.com/Yalantis/Koloda) - 基于卡片的 Tinder-style 动画效果示例。精细绝人。更赞的是额外附了详细开发教程 How We Built Tinder-Like Koloda Animation in Swift [网页链接](https://yalantis.com/blog/how-we-built-tinder-like-koloda-in-swift/) 。Yalantis 出品动画程序款款精品。   ---- (Star:3,261) (Fork:496) (Watch:115)  
...
* [RazzleDazzle](https://github.com/IFTTT/RazzleDazzle) - 【IFTTT开源Swift编写的帧动画框架--RazzleDazzle】RazzleDazzle 是IFTTT开源的一个iOS帧动画框架，非常适用于APP初次使用时的介绍和引导信息。JazzHands是UIKit一个简单的关键帧基础动画框架，可通过手势、scrollview、KVO等控制动画，被IFTTT应用在IFTTT for iPhone上。   ---- (Star:2,736) (Fork:216) (Watch:83)  
...
* [CardAnimation.swift](https://github.com/seedante/CardAnimation) - CardAnimation 是国人开发的一个用 Swift 实现卡片垂直翻转动画的 Demo, [实现思路](http://www.jianshu.com/p/286222d4edf8)。   ---- (Star:954) (Fork:115) (Watch:21)  
...
* [IBAnimatable.swift](https://github.com/JakeLin/IBAnimatable) - 第三方开源库IBAnimatable可以帮助我们在Interface Builder和Swift Playground里面设计UI, 交互, 导航模式, 换场和动画。整个App 都是通过 IBAnimatable 在Interface Builder 设计完成，没有任何一行代码。   ---- (Star:6,472) (Fork:580) (Watch:199)  
...
* [hamburger-button.swift](https://github.com/robb/hamburger-button) - hamburger-button.swift一个汉堡包动画关闭按钮。   ---- (Star:2,171) (Fork:213) (Watch:58)  
...
* [DisplaySwitcher.swift](https://github.com/Yalantis/DisplaySwitcher) - 两个集合视图在不同布局（平铺和列表）间平滑切换。Yalantis 出品。   ---- (Star:1,501) (Fork:129) (Watch:52)  
* [DynamicButton.swift](https://github.com/yannickl/DynamicButton) - 一套完整、且带动画过渡的图标按钮库。   ---- (Star:828) (Fork:54) (Watch:17)  
...
* [fantastic-ios-animation.swift](https://github.com/onmyway133/fantastic-ios-animation) - 基于 UI 组件类别分类，且带精彩动画效果的 iOS 组件库集合。   ---- (Star:2,417) (Fork:212) (Watch:86)  
* [GridPanelDemo](https://github.com/JasonZengJ/GridPanelDemo) 赞，一个点击翻转的动画Demo   ---- (Star:69) (Fork:19) (Watch:8)  

#### 算法@

* [swift-algorithm-club](https://github.com/raywenderlich/swift-algorithm-club) 很多流行的算法和数据结构的具体实现，非常赞👍👍👍   ---- (Star:13,420) (Fork:1,964) (Watch:1,048)  
...
* [awesome-swift](https://github.com/matteocrippa/awesome-swift) - A collaborative list of awesome swift resources 非常👍👍👍 .   ---- (Star:12,468) (Fork:1,746) (Watch:766)  
* [awesome-swift](https://github.com/Wolg/awesome-swift) - A curated list of awesome Swift frameworks, libraries and software.   ---- (Star:4,052) (Fork:474) (Watch:283)  
...
* [Swimat](https://github.com/Jintin/Swimat) - Swimat，是一款Xcode 插件，帮你一键格式化 swift 代码。   ---- (Star:695) (Fork:52) (Watch:24)  
...
* [CleanroomLogger](https://github.com/emaloney/CleanroomLogger) - 相当于 CocoaLumberjack 或 Log4j 的 Swift 版本，功能上甚至更强大。另外，源代码中已经内含了完整的 API 文档，使用非常方便。   ---- (Star:1,032) (Fork:77) (Watch:20)  
...
* [SwiftyBeaver](https://github.com/SwiftyBeaver/SwiftyBeaver) - 一个完善的日志工具，支持彩色输出、输出内容到文件、重要性分级、多输出目标。工具执行在后台，不影响性能，可以极大提高开发效率。   ---- (Star:2,891) (Fork:180) (Watch:59)  
...
* [Cuckoo.swift](https://github.com/SwiftKit/Cuckoo) - Cuckoo.swift一款用法更接近于传统单元测试 Mock 框架库（区别之处在于需要用脚本预先生成 Mock 类）。   ---- (Star:550) (Fork:39) (Watch:18)  
* [XCGLogger.swift](https://github.com/DaveWoodCom/XCGLogger) - XCGLogger.swift功能完整的日志管理类库。   ---- (Star:2,505) (Fork:348) (Watch:103)  
...
* [React.swift](https://github.com/alexdrone/Render) - 启发自 React 的纯 Swift 函数版基于 UIKit 封装类库。这种结构是否似曾相识。   ---- (Star:1,510) (Fork:65) (Watch:34)  
...
* [MarkdownView](https://github.com/keitaoouchi/MarkdownView) Markdown View for iOS. MarkdownView is a WKWebView based UI element, and internally use bootstrap, highlight.js, markdown-it.   ---- (Star:935) (Fork:30) (Watch:10)  
* [swift-deep-linking](https://github.com/ijoshsmith/swift-deep-linking) 深度链接 A simple way to consume custom deep link URLs in a Swift app   ---- (Star:350) (Fork:12) (Watch:9)  
* [highlight](https://github.com/taggon/highlight) Rich featured syntax highlighter for Keynote slides.   ---- (Star:208) (Fork:8) (Watch:7)  
...
* [SwiftDate](https://github.com/malcommac/SwiftDate) - 特别完整、强大的日期时间操作管理类库。它几乎涵盖了已知开源日期类库所有优秀特性。 他能帮你轻松处理时区，处理时间加减，计算到期时间等等场景下的问题。   ---- (Star:3,112) (Fork:310) (Watch:82)  
...
* [QRCodeReader.swift](https://github.com/yannickl/QRCodeReader.swift) - QRCodeReader.swift一款简单的 QR 二维码阅读组件及示例，提供前后相机切换功能。   ---- (Star:588) (Fork:161) (Watch:32)  
...
* [SwiftValidator](https://github.com/jpotts18/SwiftValidator) - 基于规则的输入验证类库。项目良好的面向对象设计思想，使规则的扩展及自定义非常方便。更专业的规则引擎（甚至是基于自然语言的规则配置）解决方案，比如：开源的 Drools，商用的 ILOG 等。   ---- (Star:910) (Fork:224) (Watch:32)  
* [Validated.swift](https://github.com/Ben-G/Validated) - Validated.swift通过值验证或限定，快速定义新类型的微类库（约50行代码）。   ---- (Star:576) (Fork:20) (Watch:15)  
* [Regex.swift](https://github.com/sharplet/Regex) - 实用的正则表达式微框架类库。   ---- (Star:417) (Fork:19) (Watch:5)  
...
* [Localize-Swift](https://github.com/marmelroy/Localize-Swift) - Localize-Swift一款开发者不可或缺的国际化及本地化字符串框架支持类库。同样地，使用简单、直观又方便。   ---- (Star:1,373) (Fork:131) (Watch:37)  
...
* [SwiftyStoreKit](https://github.com/bizz84/SwiftyStoreKit) - 一款轻量级的 iOS 应用内购买框架。   ---- (Star:2,241) (Fork:193) (Watch:66)  
* [Device-swift](https://github.com/Ekhoo/Device) - 可以非常方便的获取设备型号和屏幕尺寸，实现起来难度不大，大家可以学习一下源码。   ---- (Star:921) (Fork:73) (Watch:26)  
...
* [RxBluetoothKit.swift](https://github.com/Polidea/RxBluetoothKit) - 基于 RxSwift 的蓝牙通讯库。   ---- (Star:575) (Fork:54) (Watch:23)  
...
* [SwiftyGPIO](https://github.com/uraimo/SwiftyGPIO) - 通过 Swift 语言去控制基于 Linux 主板（比如：C.H.I.P. 和 树莓派） 的 GPIO（General Purpose Input Output ），去完成简单的工控功能（比如 LED 灯的显示）。   ---- (Star:580) (Fork:48) (Watch:43)  
...
* [FileBrowser.swift](https://github.com/marmelroy/FileBrowser) - FileBrowser.swift 一款开源的 iOS 文件浏览器, 支持文件搜索, 文件预览和 3D touch 功能。   ---- (Star:1,045) (Fork:111) (Watch:31)  
* [AFBrushBoard.swift](https://github.com/marmelroy/FileBrowser) -  AFBrushBoard.swift基于swift的毛笔画板Demo。包含多阶贝塞尔曲线的抽取、模拟画笔速度等算法。   ---- (Star:1,045) (Fork:111) (Watch:31)  
* [SwiftForms](https://github.com/ortuman/SwiftForms) - SwiftForms表单递交库，快速开发利器。   ---- (Star:1,081) (Fork:172) (Watch:67)  
* [Design-Patterns-In-Swift](https://github.com/ochococo/Design-Patterns-In-Swift) - Design-Patterns-In-Swift如何使用常用设计模式及示例。   ---- (Star:8,325) (Fork:877) (Watch:557)  
...
* [Surge.swift](https://github.com/mattt/Surge) - Surge.swift基于苹果Accelerate高性能计算数学框架封装库。   ---- (Star:3,706) (Fork:349) (Watch:153)  
* [Async.swift](https://github.com/duemunk/Async) - Async.swift简洁的后台执行代码的异步封装库。   ---- (Star:4,045) (Fork:273) (Watch:79)  
* [AlecrimAsyncKit.swift](https://github.com/Alecrim/AlecrimAsyncKit) - 一款很优雅的异步执行框架库。   ---- (Star:68) (Fork:4) (Watch:4)  
* [BrightFutures.swift](https://github.com/Thomvis/BrightFutures) - BrightFutures.swift漫长或复杂计算由独立线程异步来完成。   ---- (Star:1,473) (Fork:143) (Watch:54)  
* [Euler.swift](https://github.com/mattt/Euler) - Euler.swift直观、简洁的数学表达式∛27÷3+∑[3,1,2]。   ---- (Star:848) (Fork:46) (Watch:31)  
* [Siren.swift](https://github.com/ArtSabintsev/Siren) - Siren.swift当应用更新时，通知用户并提供App Store链接。   ---- (Star:1,952) (Fork:163) (Watch:48)  
* [BTree.swift](https://github.com/lorentey/BTree) - BTree.swift:相对于标准集合类型具有更优执行性能的基于B-Tree的优化集合类型实现类库。   ---- (Star:916) (Fork:62) (Watch:23)  
...
* [Bolts-Swift](https://github.com/BoltsFramework/Bolts-Swift) - 全平台（所有支持 Swift 的设备）任务管理 futures/promises 异步实现类库。   ---- (Star:987) (Fork:82) (Watch:36)  
...
* [EZSwiftExtensions](https://github.com/goktugyil/EZSwiftExtensions) - 对Swift标准库， Foundation， UIKit 提供了很多高级扩展函数。   ---- (Star:2,137) (Fork:255) (Watch:70)  
...
* [MotionBook](https://github.com/younatics/MotionBook) Awesome iOS UI/UX Animation Book   ---- (Star:752) (Fork:56) (Watch:19)  

#### 地图@

* [Cluster](https://github.com/efremidze/Cluster) 非常不错的地图标注聚合.   ---- (Star:652) (Fork:40) (Watch:14)  

#### 通知@

* [NotificationBanner](https://github.com/Daltron/NotificationBanner) 最容易的方法显示高度自定义的通知.   ---- (Star:1,248) (Fork:81) (Watch:13)  
...
* [OAuthSwift](https://github.com/OAuthSwift/OAuthSwift) - OAuthSwift国外主流网站OAuth授权类库。   ---- (Star:1,721) (Fork:323) (Watch:69)  
* [CryptoSwift](https://github.com/krzyzanowskim/CryptoSwift) - swift加密库, 支持md5,sha1,sha224,sha256...。   ---- (Star:4,108) (Fork:483) (Watch:121)  
...
* [MMWormhole.swift](https://github.com/mutualmobile/MMWormhole) - MMWormhole.swift:iOS或OS X扩展与宿主应用的通讯框架。   ---- (Star:3,256) (Fork:237) (Watch:137)  
...
* [ShadowsocksX-NG](https://github.com/shadowsocks/ShadowsocksX-NG) Next Generation of ShadowsocksX   ---- (Star:4,452) (Fork:1,165) (Watch:266)  
* [vpnon](https://github.com/lexrus/vpnon/) - swift的VPN On 的源码和本地化内容都是开放的: [官方网站](https://crowdin.com/project/vpnon)。   ---- (Star:3,130) (Fork:610) (Watch:138)  
* [Potatso](https://github.com/haxpor/Potatso) 一个实现Shadowsocks代理的客户端.   ---- (Star:178) (Fork:159) (Watch:22)  

#### 物联网@

#### mac@

* [iina](https://github.com/lhc70000/iina) The modern video player for macOS,非常👍👍👍 .   ---- (Star:6,886) (Fork:497) (Watch:228)  
* [swift14macOSApps](https://github.com/KrisYu/swift14macOSApps) 几个Mac小Demo.   ---- (Star:407) (Fork:42) (Watch:9)  

#### 未分类@

* [AlternativeIcon-Example](https://github.com/KimDarren/AlternativeIcon-Example) 😱 Change your iOS application's icon programmatically since iOS 10.3   ---- (Star:118) (Fork:9) (Watch:3)  
